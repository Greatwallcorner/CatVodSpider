...
//        System.out.println(HtmlUtil.cleanHtmlTag(s));
    ...
    public void hostTest() {
        ...
        System.out.println(URIUtils.extractHost(URI.create(host)));
    }

    @Test
    public void test(){
        System.setProperty("sun.net.http.allowRestrictedHeaders", "true");
        String url = "https://t20m.nboku.com/20250218/aVGjV32O/index.m3u8?sign=XrYH93%252FS9FESo%252BVjZilF2bgREm8KCOadAqh5AkGze28%253D";
//        String string = OkHttp.string(url, com.github.catvod.utils.Util.webHeaders("https://tv.gboku.com/", url, ""));
        String string = OkHttp.string(url);

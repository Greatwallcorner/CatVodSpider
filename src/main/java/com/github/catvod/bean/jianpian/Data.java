...
public class Data {
    ...
    public String getJumpId() {
        return StringUtils.isEmpty(jumpId) ? "" : jumpId;
    }

    public String getThumbnail() {
        return StringUtils.isEmpty(thumbnail) ? "" : thumbnail + "@Referer=www.jianpianapp.com@User-Agent=jianpian-version362";
    }
    ...
    public String getMask() {
        return StringUtils.isEmpty(mask) ? getPlaylist() : mask;
    }

    public String getDescription() {
        return StringUtils.isEmpty(description) ? "" : description.replace("　", "");
    }
    ...
    public static class BtboDown {
        ...
        public String getVal() {
            return StringUtils.isEmpty(val) ? "" : val.replaceAll("ftp", "tvbox-xg:ftp");
        }
    }
}

...
public class Supjav extends Spider {
    ...
    @Override
    public String playerContent(String flag, String id, List<String> vipFlags) throws URISyntaxException {
        Map<String, List<String>> respHeaders = new HashMap<>();
        OkHttp.stringNoRedirect(playUrl + "supjav.php?c=" + new StringBuilder(id).reverse(), getHeaders(playUrl), respHeaders);
        String redirect = OkHttp.getLocation(respHeaders);
        switch (flag) {
            case "TV":
